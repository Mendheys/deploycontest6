let server_url = "https://glacial-bastion-32625.herokuapp.com/cars"
    ...
    fetch(url).then((res) => res.json()).then((res) => {
        res.map((el) => {
            ...
            deleteBtn.addEventListener("click", async () => {
                container
                let delete_link = `https://glacial-bastion-32625.herokuapp.com/cars/${el.id}`
            ...
            edit.addEventListener("click", () => {
                let edit_link = `https://glacial-bastion-32625.herokuapp.com/cars/${el.id}`
            ...
            divOne.append(image,Yname,AM,KM,price,des,deleteBtn,edit,wishList);
...
function handleFilter(){
    let link = `https://glacial-bastion-32625.herokuapp.com/cars?brand=${filter.value}`
    fetchfromurl(link)
}
